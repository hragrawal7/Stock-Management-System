                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <%
                                        ...
                                        PreparedStatement ps = con.prepareStatement("select id from staff where staff_id = ? ");
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="Dashboard/views/DB/profile.jsp?id=<%=rs.getString("id")%>" class="btn btn-default btn-flat">Edit Profile</a>
                                        </div>
...
<!--            <div class="row">
            ...
            <center><h2>LOW STOCK PRODUCTS</h2></center>
            <div class="container">
                ...
                <%
                    ...
                    String sqlPagination = "SELECT SQL_CALC_FOUND_ROWS * FROM product where p_quantity < 5 limit " + iPageNo + "," + iShowRows + "";
                        ...
                        <table class="table table-hover">
                            ...
                            <div class="container">
                                <ul class="pagination">
                                    ...
                                    %>
                                    <li> <a href="main.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a></li>
                                        <%
                                            }
                                        ...
                                        %>
                                    <li> <a href="main.jsp?iPageNo=<%=i%>"><b><%=i%></b></a></li>
                                                <%
                                                } else if (i <= iTotalPages) {
                                                %>
                                    <li> <a href="main.jsp?iPageNo=<%=i%>"><%=i%></a></li>
                                        <%
                                                }
                                            }
                                            if (iTotalPages > iTotalSearchRecords && i < iTotalPages) {
                                        %>
                                    <li>  <a href="main.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> </li>
                                        <%
                                                }
                                            }
                                        %>

...
<%} else {
   ...
   PreparedStatement p = con.prepareStatement("select category from staff where staff_id=?");
    p.setString(1, userid);
    ResultSet rs=p.executeQuery();
    if(rs.next())
    {
        if(!(rs.getString("category").equals("Manager")))
        {
            %>
            <script>
                alert("You are not allowed to see it");
                    ...
                    <table>
                        <tr> 
                            <td><div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="staff_id" name="staff_id" pattern="[a-zA-Z].*" placeholder="Enter Your Staff Id" required>
                                </div><br></td>
                            <td><div class="form-group">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mobile_no" name="mobile_no" pattern="[1-9][0-9]{9}" placeholder="Enter Your Mobile No" required>
                                </div><br>
                            </td>

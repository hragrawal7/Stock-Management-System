            ...
            <main>
                <div class="panel panel-primary" >
                    <div class="container">
                        ...
                        %>
                        <form class="col-xs-12 col-sm-12 col-md-10" action="UpdateStaff.jsp" style="align:center;">
                            ...
                            <table style="width:60%;">
                                <tr> 
                                    <td><div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="staff_id" name="staff_id"  pattern="[a-zA-Z].*" value="<%= u.getStaff_id()%>" placeholder="Enter Your User Id">
                                        </div>
                                    </td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td><div class="form-group">
                                            <label for="password">Password:</label><br>
                                            <input type="text" class="form-control" id="password" name="password" value="<%= u.getPassword()%>" placeholder="Enter Your Password" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="mobile_no" name="mobile_no" pattern="[1-9][0-9]{9}" value="<%= u.getMobile_no()%>"  placeholder="Enter Your Mobile No">
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select class="form-control" id="category" name="category" value="" readonly>

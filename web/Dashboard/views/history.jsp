...
<html>
    <head>
        ...
        <script>
            function SearchBillByMemberID() {
                var v = document.getElementById("member_id").value;
                var url = "SearchBillByMemberID.jsp?member_id=" + v;
            ...
            function SearchBillByDate() {
                ...
                var url = "SearchBillByDate.jsp?date=" + v;
                if (window.XMLHttpRequest) {
                    request = new XMLHttpRequest();
                } else if (window.ActiveXObject) {
                    request = new ActiveXObject("Microsoft.XMLHTTP");
            ...
            function SearchBillByBillID() {
                var v = document.getElementById("bill_id").value;
                var url = "SearchBillByBillID.jsp?bill_id=" + v;
                if (window.XMLHttpRequest) {
                    request = new XMLHttpRequest();
                } else if (window.ActiveXObject) {
                    request = new ActiveXObject("Microsoft.XMLHTTP");
        ...
        <div class="container">
            <div class="pull-right" style="margin-right: 4%;">
                <div class="form-inline">
                    ...
                    <input type="button" class="btn btn-primary" onclick="SearchBillByMemberID()" value="Search"/>
                </div>
            </div>
            <div class="pull-right" style="margin-right: 1%;">
                <div class="form-inline">
                    <input type="date" class="form-control" name="date" id="date"/>
                    <input type="button" class="btn btn-primary" onclick="SearchBillByDate()" value="Search"/>
                </div>
            </div>

            <div class="pull-right" style="margin-right: 1%;">
                <div class="form-inline">
                    <input type="text" class="form-control" name="bill_id" id="bill_id" placeholder="Enter Bill ID"/>
                    <input type="button" class="btn btn-primary" onclick="SearchBillByBillID()" value="Search"/>
                </div>
            </div>
            <br><br>
            ...
            <%
                ...
                String sqlPagination = "SELECT SQL_CALC_FOUND_ROWS * FROM bill limit " + iPageNo + "," + iShowRows + "";
            ...
            %>
            <div class="panel panel-primary" style="overflow: hidden;margin-right: 5%;width:96%;">
                <div class="container" id="t1">
                    <center><h2>Recent Sales History</h2></center>
                    <table class="table table-hover" style="width:95%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=rsPagination.getString("bill_id")%></td>
                                <td><%=rsPagination.getString("member_id")%></td>
                                <td><%=rsPagination.getString("final_amt")%></td>
                                <td>
                                    <a href="ViewBill.jsp?bill_id=<%=rsPagination.getInt("bill_id")%>" class="btn btn-success btn-sm btn-icon icon-left" role="button">
                        ...
                        <div class="container">
                            <ul class="pagination">
                                ...
                                %>
                                <li> <a href="history.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a></li>
                                    <%
                                        }
                                    ...
                                    %>
                                <li> <a href="history.jsp?iPageNo=<%=i%>"><b><%=i%></b></a></li>
                                            <%
                                            } else if (i <= iTotalPages) {
                                            %>
                                <li> <a href="history.jsp?iPageNo=<%=i%>"><%=i%></a></li>
                                    <%
                                            }
                                        }
                                        if (iTotalPages > iTotalSearchRecords && i < iTotalPages) {
                                    %>
                                <li>  <a href="history.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> </li>
                                    <%
                                            }
                                        }
                                    %>
